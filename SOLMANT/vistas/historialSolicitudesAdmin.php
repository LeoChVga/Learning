...
<body>
    ...
    <div class="container">
      ...
      r.idreportes FROM reportes AS r
      INNER JOIN usersjefes AS j ON j.idJefe = r.IdJefe INNER JOIN usersempleados AS e on r.idEmpleado=e.idEmpleados WHERE r.idAdmin='$idAdmin'  ORDER BY r.FechaReporte DESC";
                ...
                if (mysqli_num_rows($results) > 0) {
                    ...
                    while ($consulta = mysqli_fetch_array($results)) {
                        ...
                        echo "<tr>
                        <form id='form1' name='form1' method='post' action='../generarpdf.php'>
                      <td>" . $consulta[0] . "</td> 
                      ...
                      <td>" . $consulta[5] . "</td>
                      <td>" . $consulta[7] . "</td>
                      <input type='hidden' name='idReporte' value='".$consulta[8]."'>

                               
                      <td>";
                      echo "<div class='d-flex justify-content-center align-items-center mt-2'>
                        <button type='submit' class='btn btn-primary h-25' >Imprimir</button>
                    </div>
                        </form>
                    </div>
                </td></tr>";
                    ...
                    echo "<tr>
            <td colspan='8' class='text-center'>No hay reportes pendientes por asignar $idAdmin.</td>
          </tr>";
                }
